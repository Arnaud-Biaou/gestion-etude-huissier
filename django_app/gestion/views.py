...
def get_default_context(request):
    ...
    modules = [
        ...
        {'id': 'tresorerie', 'label': 'Tresorerie', 'icon': 'piggy-bank', 'category': 'finance', 'url': 'tresorerie'},
        {'id': 'comptabilite', 'label': 'Comptabilite', 'icon': 'bar-chart-3', 'category': 'finance', 'url': 'comptabilite'},
